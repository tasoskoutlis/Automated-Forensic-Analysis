...
def returnPrograms(fileSignature):
    ...
    programsDict = {'txt' : ['wordpad', 'notepad', 'notepad++', 'dreamweaver', 'editpad', 'pdfcreator', 'uedit32', 'swriter'], 
                    ...
                    'jpg' : ['explorer', 'fsviewer', 'gimp', 'photoviewer', 'picasaphotoviewer', 'rundll32'], 
                    'png' : ['explorer', 'fsviewer', 'gimp', 'i_view32', 'mediainfo', 'paintdotnet', 'rundll32', 'shimgvw', 'wlxphotogallery', 'photoshop', 'photoviewer', 'picasaphotoviewer'], 
